  ...
  return (
    <div>
      <section className="mx-auto max-w-[1500px] px-4 pt-12 screen-size-12:text-left text-center">
        ...
        <p className="my-12 leading-relaxed text-gray-700">
          {services?.paragraph2}
        </p>
      </section>
      ...
      <section className="mx-auto max-w-[1500px] px-4 pt-2 pb-10 screen-size-12:text-left text-center">
        <h2 className="text-3xl font-extrabold tracking-tight text-blue-800 sm:text-4xl mb-6">
          {get_started?.title}
        </h2>
        <div className="space-y-6 max-w-[1500px] mx-auto text-gray-700 leading-relaxed">
