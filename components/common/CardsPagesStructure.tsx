...
export default function CardsPagesStructure({
  ...
  // Build FAQ JSON-LD from the same data we render (prevents drift)
  ...
  "
      ...
      <main id="main-content" className="text-lg">
        <section
        ...
        >
          <div className="relative w-full screen-size-5:h-[400px] h-[800px]">
            ...
            <div className="absolute inset-0 bg-black/60 p-6 flex flex-col justify-center items-start text-white text-left">
