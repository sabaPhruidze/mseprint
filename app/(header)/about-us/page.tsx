...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "commercial printer Minneapolis MN",
    "local print shop Minneapolis",
    "signage and graphics Minneapolis",
    "marketing print solutions Minneapolis",
    "company history MSE Printing",
    "our team MSE Printing",
    "customer service printing Minneapolis",
    "why choose MSE Printing",
    "since 1985 printer Minneapolis",
  ],
