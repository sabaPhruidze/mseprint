...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "ADA compliant signage Minneapolis",
    "braille signs Minneapolis",
    "tactile room signs",
    "restroom ADA signs",
    "wayfinding signs Minneapolis",
    "directional signage Minnesota",
    "interior building signs MN",
    "room number and door signs",
    "office directory signs",
    "hospital wayfinding signage",
    "school campus signage",
    "healthcare ADA signage",
    "photopolymer ADA signs",
    "raised text and braille signs",
    "custom braille plaques",
    "code-compliant signage Minnesota",
    "architectural signage Minneapolis",
    "sign design and installation MN",
    "facility wayfinding systems",
    "lobby and reception signs",
    "emergency egress maps signage",
    "tenant and suite signs",
...
const AdaWayFindingSigns = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "signs/ada-wayfinding-signs", // must match the DB `path`
    footerContentData
  );
