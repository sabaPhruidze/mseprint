...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "short run custom boxes",
    "prototype packaging printing",
    "short run carton printing",
    "short run retail packaging",
    "short run packaging printing",
    "low minimum packaging",
    "mid-size packaging runs",
    "pilot run packaging",
    "limited edition packaging",
    "seasonal packaging design",
    "product packaging Minneapolis",
    "luxury packaging short run",
    "folding carton short run",
...
const ShortRunPackaging = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "short-run-packaging", // must match the DB `path`
    footerContentData
  );
