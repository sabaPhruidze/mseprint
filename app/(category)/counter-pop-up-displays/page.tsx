...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "pop up displays Minneapolis",
    "portable counter displays Minneapolis",
    "trade show counters Minneapolis",
    "event counters Minneapolis",
    "registration counters Minneapolis",
    "kiosk displays Minneapolis",
    "collapsible counter graphics",
    "magnetic frame counters",
    "shipping case to counter",
    "tabletop counters Minneapolis",
    "SEG fabric counters",
    "tension fabric pop up displays",
    "backlit LED counters",
    "fabric pop up displays Minneapolis",
    "vinyl wrap counter graphics",
    "PVC panel counter graphics",
    "replacement counter graphics",
    "custom booth counters Minneapolis",
    "portable display printing Minneapolis",
    "retail pop up stands Minneapolis",
    "marketing display printing Minneapolis",
    "trade show pop up walls Minneapolis",
    "tool free setup displays",
    "lightweight portable displays",
    "rush pop up displays Minneapolis",
    "same day display printing Minneapolis",
    "Twin Cities counter displays",
    "MSE Printing counter and pop up displays",
  ],
