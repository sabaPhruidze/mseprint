...
export const metadata: Metadata = {
  ...
  keywords: [
    "targeted direct mail Minneapolis MN",
    "data-driven direct mail Minneapolis",
    "direct mail services Minneapolis",
    "mailing list segmentation Minneapolis",
    "variable data printing Minneapolis",
    "personalized mailers Minnesota",
    "direct mail marketing Minnesota",
    "NCOA/CASS processing Minneapolis",
    "address verification Minneapolis",
    "postcard marketing Minneapolis",
    "direct mail list management",
    "B2B direct mail Minneapolis",
    "nonprofit fundraising mail Minneapolis",
    "ZIP+4 targeting Minnesota",
    "Twin Cities direct mail company",
  ],
