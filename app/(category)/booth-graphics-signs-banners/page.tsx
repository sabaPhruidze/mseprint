...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "trade show displays Minneapolis",
    "custom signs Minneapolis",
    "banner printing Minneapolis",
    "large format printing Minneapolis",
    "event signage Minneapolis",
    "retractable banners Minneapolis",
    "fabric banners Minneapolis",
    "backlit lightbox graphics Minneapolis",
    "SEG fabric graphics Minneapolis",
    "pop up displays Minneapolis",
    "hanging signs Minneapolis",
    "floor graphics Minneapolis",
    "window graphics Minneapolis",
    "wayfinding and directional signs Minneapolis",
    "corporate signage Twin Cities",
    "custom booth backdrops Minneapolis",
    "tabletop displays Minneapolis",
    "vinyl banners Minneapolis",
    "gatorboard and foam board prints Minneapolis",
    "same day banner printing Minneapolis",
    "rush trade show printing Minneapolis",
    "printing services Minneapolis",
    "print shop Minneapolis",
    "printing company Minnesota",
    "commercial printing services USA",
    "booth installation Minneapolis",
    "MSE Printing booth graphics",
  ],
