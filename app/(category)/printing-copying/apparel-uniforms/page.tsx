...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "company uniforms Minneapolis",
    "embroidered shirts Minneapolis",
    "custom t-shirts Minneapolis",
    "custom polos Minneapolis",
    "screen printing Minneapolis",
    "branded clothing Minneapolis",
    "corporate apparel Minneapolis",
    "branded safety gear Minneapolis",
    "hi-vis safety vests Minnesota",
    "work uniforms Minneapolis",
    "custom hats embroidery Minneapolis",
    "restaurant uniforms Minneapolis",
    "medical scrubs embroidery Minneapolis",
...
const ApparelUniforms = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "printing-copying/apparel-uniforms", // must match the DB `path`
    footerContentData
  );
