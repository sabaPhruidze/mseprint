...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "custom posters Minneapolis",
    "large format poster printing Minneapolis",
    "same day poster printing Minneapolis",
    "rush poster printing Minneapolis",
    "photo poster printing Minneapolis",
    "event posters Minneapolis",
    "trade show posters Minneapolis",
    "retail promotional posters Minneapolis",
    "professional poster printing",
    "foam board mounted posters Minneapolis",
    "gatorboard posters Minneapolis",
    "laminated posters Minneapolis",
    "matte or gloss posters",
    "indoor outdoor posters",
    "waterproof posters",
    "24x36 posters Minneapolis",
    "18x24 posters Minneapolis",
    "wide format printing Minneapolis",
