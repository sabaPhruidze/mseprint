...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "catalog printing Minneapolis",
    "booklet printing Minneapolis",
    "training manual printing Minneapolis",
    "technical manual printing",
    "user manual printing",
    "instruction booklet printing",
    "product catalogs Minneapolis",
    "marketing catalogs Minnesota",
    ...
    "high-volume booklet printing",
    "color matched printing Minneapolis",
    "Twin Cities printing",
    "MSE Printing manuals catalogs booklets",
  ],
...
const ManualsCatalogsBooklets = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "printing-copying/manuals-catalogs-booklets", // must match the DB `path`
    footerContentData
  );
