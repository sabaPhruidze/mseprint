...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "custom business cards Minneapolis",
    "premium business cards Minnesota",
    "business card design Minneapolis",
    "thick card stock business cards",
    "soft touch business cards",
    "matte or gloss business cards",
    "spot UV business cards",
    "foil stamped business cards",
    "embossed business cards",
    "debossed business cards",
    "letterpress business cards Minneapolis",
    "edge painted business cards",
    "rounded corner business cards",
    "die cut business cards",
    "plastic business cards",
    "metal business cards",
    "NFC business cards Minneapolis",
    "QR code business cards",
    "Pantone color matched cards",
    "eco friendly business cards",
    "recycled paper business cards",
    "rush business cards Minneapolis",
    "same day business cards Minneapolis",
    "double sided business cards",
    "luxury business cards",
    "corporate business cards",
    "Twin Cities business card printing",
...
const CustomBusinessCardPrinting = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "printing-copying/custom-business-card-printing", // must match the DB `path`
    footerContentData
  );
  if (!pageData) {
