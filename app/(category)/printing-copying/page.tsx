...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "copying Minneapolis MN",
    "print shop Minneapolis",
    "copy shop Minneapolis",
    "color copies Minneapolis",
    "black and white printing Minneapolis",
    "same day printing Minneapolis",
    "bulk printing services Minneapolis",
    "business document printing",
    "presentation printing Minneapolis",
    "scanning and copying Minneapolis",
    "document binding Minneapolis",
    "spiral and comb binding",
    "booklet printing Minneapolis",
    "MSE Printing Minneapolis",
  ],
