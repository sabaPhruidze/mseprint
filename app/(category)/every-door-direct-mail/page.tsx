...
export const metadata: Metadata = {
  ...
  keywords: [
    "EDDM Minneapolis",
    "Every Door Direct Mail Minneapolis",
    "Every Door Direct Mail",
    "no list direct mail campaign",
    "EDDM postcards Minneapolis",
    "EDDM sizes and requirements",
    "EDDM postage rates Minneapolis",
    "EDDM map and routes",
    ...
    "grand opening mailers Minneapolis",
    "restaurant direct mail Minneapolis",
    "real estate EDDM postcards",
    "political EDDM Minnesota",
    "nonprofit EDDM mailings",
    "EDDM design and print",
    "USPS-compliant EDDM design",
    "EDDM bundling and drop-off",
    "EDDM indicia / permit imprint",
    "oversized postcards 12x15",
    "folded self-mailer 6x10.5",
    "local mail marketing Minneapolis",
