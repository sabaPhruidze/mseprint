...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "countertop display printing Minneapolis",
    "kiosk wraps Minneapolis",
    "trade show tabletop displays",
    "mini signage Minneapolis",
    "portable counter displays",
    "POP countertop displays",
    "retail counter signage",
    "tabletop banner stands",
    "custom kiosk graphics",
    "small-footprint event displays",
    "branded counter signs",
    "event kiosk printing",
    "MSE Printing tabletop displays",
    "compact display solutions Minneapolis",
  ],
