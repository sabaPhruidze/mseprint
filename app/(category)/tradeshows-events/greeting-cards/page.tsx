...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "business holiday cards Minneapolis",
    "corporate greeting cards Minnesota",
    "thank you cards Minneapolis",
    "birthday cards printing Minneapolis",
    "photo Christmas cards Minneapolis",
    "custom invitations Minneapolis",
    "event invitations Minneapolis",
    "folded greeting cards Minneapolis",
    "flat greeting cards Minneapolis",
    "5x7 greeting cards Minneapolis",
    "A7 greeting cards Minneapolis",
    "envelope addressing Minneapolis",
    "foil stamped greeting cards",
    "embossed greeting cards",
    "raised UV / spot UV cards",
    "soft touch lamination cards",
    "letterpress cards Minneapolis",
    "die cut greeting cards",
    "recycled paper greeting cards",
    "eco friendly greeting cards",
    "same day greeting cards Minneapolis",
    "rush greeting card printing Minneapolis",
    "Twin Cities greeting card printing",
...
const GreetingCards = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "tradeshows-events/greeting-cards", // must match the DB `path`
    footerContentData
  );
