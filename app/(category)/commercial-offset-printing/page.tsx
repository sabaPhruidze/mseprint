...
export const metadata: Metadata = {
  ...
  keywords: [
    "offset printing Minneapolis MN",
    "commercial offset printing Minneapolis",
    "sheetfed offset press services",
    "long-run brochure printing",
    "catalog and magazine printing",
    "Pantone spot color matching",
    "CMYK color management",
    "bulk printing Twin Cities",
    "annual report printing Minnesota",
    "business flyer printing offset",
...
const CommercialOffsetPrinting = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "commercial-offset-printing", // must match the DB `path`
    footerContentData
  );
