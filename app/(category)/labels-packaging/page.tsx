...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "short run packaging Minneapolis",
    "small run packaging",
    "short run carton printing",
    "custom boxes Minneapolis",
    "mailer boxes and tuck boxes",
    "folding carton printing Minneapolis",
    "shrink sleeves and flexible packaging",
    "packaging design Minneapolis",
    "dieline creation and prototyping",
    "foil emboss deboss packaging",
    "spot UV and soft touch",
    "eco friendly recycled packaging",
    "luxury packaging Minnesota",
    "MSE Printing labels and packaging",
  ],
...
const LabelsPackaging = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "labels-packaging", // must match the DB `path`
    footerContentData
  );
