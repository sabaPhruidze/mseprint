...
export const metadata: Metadata = {
  ...
  keywords: [
    "custom packaging Minneapolis MN",
    "custom boxes Minneapolis",
    "product packaging design Minneapolis",
    "retail packaging solutions Minnesota",
    "ecommerce packaging boxes",
    "folding carton packaging",
    "corrugated shipping boxes",
    "rigid setup boxes",
    "luxury packaging Minneapolis",
    "eco-friendly packaging printing",
    "custom mailer boxes",
    "packaging dieline & prototyping",
...
const CustomPackaging = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "labels-packaging/custom-packaging", // must match the DB `path`
    footerContentData
  );
