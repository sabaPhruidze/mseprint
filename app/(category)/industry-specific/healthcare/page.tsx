...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "HIPAA compliant printing Minneapolis",
    "hospital signage Minneapolis",
    "clinic forms printing",
    "medical form printing Minnesota",
    "patient education materials",
    "appointment cards printing",
    "medical brochures Minneapolis",
    "healthcare signage printing",
    "medical stationery design",
    "prescription pads printing MN",
    "waiting room posters",
    "wayfinding hospital signage",
    "ADA healthcare signage",
    "lab labels and wristbands printing",
    "patient communication materials",
    "healthcare marketing print",
