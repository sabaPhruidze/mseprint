...
export const metadata: Metadata = {
  ...
  keywords: [
    "real estate printing Minneapolis",
    "realtor printing Minneapolis",
    "real estate signs Minneapolis",
    "yard signs for realtors Minneapolis",
    "open house signs Minneapolis",
    "property brochure printing Minneapolis",
    "real estate flyers Minneapolis",
    "listing presentation folders Minneapolis",
    "realtor business cards Minneapolis",
    "real estate postcards Minneapolis",
    "for sale sign printing Minneapolis",
    "real estate marketing materials Minnesota",
    "Twin Cities real estate printing",
    "MLS listing print materials",
    "luxury real estate brochures",
    "property feature sheets",
    "door hangers for realtors",
    "MSE Printing real estate",
  ],
