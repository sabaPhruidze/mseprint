...
export const metadata: Metadata = {
  ...
  keywords: [
    "industry-specific printing Minneapolis",
    "industry printing services Minneapolis",
    "sector focused printing Minnesota",
    "real estate printing services Minneapolis",
    "real estate brochures and flyers",
    "property listing brochures Minneapolis",
    "yard signs and riders Minneapolis",
    "legal printing Minneapolis",
    "legal brief printing services",
    "court document printing Minneapolis",
    "healthcare printing Minneapolis",
    "HIPAA compliant printing",
    "patient forms and appointment cards",
    "education printing Minneapolis",
    "school and university printing",
    "course packs and workbooks",
    "finance printing Minneapolis",
    "statement and notice printing",
    "annual report printing Minneapolis",
    "retail printing Minneapolis",
    "point of sale signage POS",
    "shelf talkers and window graphics",
    "restaurant menu printing Minneapolis",
    "takeout menus and table tents",
    "political campaign printing Minnesota",
    "union political printing",
    "nonprofit fundraising print Minneapolis",
    "manufacturing printing Minneapolis",
    "safety labels and manuals",
    "Twin Cities industry printing",
    "MSE Printing industry solutions",
  ],
