...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "invitation printing Minneapolis MN",
    "custom wedding invitations Minneapolis",
    "wedding invitation printers Minneapolis",
    "holiday cards printing Minneapolis",
    "thank you cards Minneapolis",
    "business invitation cards Minneapolis",
    "personalized greeting cards Minneapolis",
    "event invitation printing Minneapolis",
    "custom cards Minneapolis MN",
    "MSE Printing invitations",
  ],
...
const CardsInvitations = async () => {
  ...
  const breadcrumbs = buildServiceBreadcrumbs(
    "cards-invitations", // must match the DB `path`
    footerContentData
  );
